...
{{@elseif {{$ ../property_type/__value__}} == "Date"}}
			$table->date('{{$ ../name/__value__/__lowercase_text__}}')->default(NULL);
...
{{@elseif {{$ ../property_type/__value__}} == "EmailAddress"}}
			$table->string('{{$ ../name/__value__/__lowercase_text__}}')->default(NULL);
{{@elseif {{$ ../property_type/__value__}} == "HTMLEditor"}}
			$table->longText('{{$ ../name/__value__/__lowercase_text__}}')->default(NULL);
